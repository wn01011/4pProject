...
module.exports = class productAskTable extends Sequelize.Model {
  ...
  static init(sequelize) {
    return super.init(
      ...
      },
      {
        ...
        modelName: "Productask_Table", // Javascript에서 사용하는 테이블명
        tableName: "productask_table", // MySQL에 있는 테이블명
