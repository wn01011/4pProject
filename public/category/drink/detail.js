...
//     filterImg.src = `./imges/detailImg/check-circle.svg`;
...
const fruitCategories = function (category) {
  try {
    ...
    tempBroA.innerText = `커피`;
    tempEnvA.innerText = `생수·탄산수`;
    tempOniA.innerText = `차`;
    tempPotaA.innerText = `음료·주스`;
    tempSpiA.innerText = `우유·두유·요거트`;
