...
const fruitCategories = function (category) {
  try {
    ...
    tempBroA.innerText = `식용유·참기름·오일`;
    tempEnvA.innerText = `파스타·면류`;
    tempOniA.innerText = `소금·설탕·향신료`;
    tempPotaA.innerText = `식초·소스·드레싱`;
    tempCucA.innerText = `밀가루·가루·믹스`;
    tempSpiA.innerText = `양념·액젓·장류`;
